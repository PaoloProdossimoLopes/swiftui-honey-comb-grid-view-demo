    ...
    func path(in rect: CGRect) -> Path {
        ...
        return Path { path in
            let pt1 = CGPoint(x: 0, y: 20),
                pt2 = CGPoint(x: 0, y: rect.height - 20),
                pt3 = CGPoint(x: rect.width / 2, y: rect.height),
                pt4 = CGPoint(x: rect.width, y: rect.height - 20),
                pt5 = CGPoint(x: rect.width, y: 20),
                pt6 = CGPoint(x: rect.width / 2, y: 0)
